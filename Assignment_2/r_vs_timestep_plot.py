...
Usage
-----
# After running: python dqn_mountaincar.py --truncation 2000 --replay_factor 1
python plot_results.py --log_dir logs --truncation 2000 --replay_factor 1

# Save figure instead of showing
python plot_results.py --log_dir logs --truncation 2000 --replay_factor 1 --save
"""
