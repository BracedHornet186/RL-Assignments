...
Usage
-----
python plot_rho_comparison.py --log_dir logs_per
python plot_rho_comparison.py --log_dir logs_per --save
python plot_rho_comparison.py --log_dir logs_per --rhos 1 2 4 8
"""
