...
python vanilla_dqn_parallel.py --truncation 2000 --replay_factor 1 --workers 8

# Force CPU-only
python vanilla_dqn_parallel.py --device cpu --workers 8

# Single seed debug (no subprocess overhead)
python vanilla_dqn_parallel.py --seeds 0 --workers 1
"""
