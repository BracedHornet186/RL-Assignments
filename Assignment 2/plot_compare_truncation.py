...
Usage
-----
python plot_compare_truncation.py --log_dir logs --replay_factor 1
python plot_compare_truncation.py --log_dir logs --replay_factor 1 --save
"""
