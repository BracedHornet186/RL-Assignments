...
python vanilla_dqn_eval.py --ckpt logs/weights/trunc2000_rho1_seed0_best.pt

# Run 5 episodes, show stats
python vanilla_dqn_eval.py --ckpt logs/weights/trunc2000_rho1_seed0_best.pt --episodes 5

# Run without rendering (just print stats)
python vanilla_dqn_eval.py --ckpt logs/weights/trunc2000_rho1_seed0_best.pt --no_render
"""
