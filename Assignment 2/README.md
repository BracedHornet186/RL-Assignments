...
* **`logs_hyperparameter_tuning/`**: Contains logs and final weights (of all 15 seeds) of models trained on different hyperparameters.
* **`plots/`**: Contains all plots generated by plotting scripts.
