...
def train_worker(seed):
    ...
    # Seed the environment for the first reset
...
if __name__ == "__main__":
    # Same 10 random seeds used for Q-Learning for a fair comparison
    seeds = [42, 101, 202, 303, 404, 505, 606, 707, 808, 909]
    
    print(f"Starting SARSA runs on 10 seeds with LR=0.01, Eps=0.3...")
